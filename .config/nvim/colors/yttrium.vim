" Vim color file - yttrium
" Generated by http://bytefluent.com/vivify 2014-10-12
set background=dark
if version > 580
	hi clear
	if exists("syntax_on")
...
hi TabLineFill ctermfg=240 ctermbg=NONE
hi TabLine ctermfg=240 ctermbg=NONE
hi TabLineSel ctermfg=173 ctermbg=NONE 
...
hi LineNr guifg=#544e4d guibg=#151515 guisp=#151515 gui=NONE ctermfg=240 ctermbg=233 cterm=NONE
...
hi cursorim guifg=#3a3940 guibg=#ff50e5 guisp=#ff50e5 gui=NONE ctermfg=238 ctermbg=206 cterm=NONE
...
hi mbenormal guifg=#99cc80 guibg=#3f2839 guisp=#3f2839 gui=NONE ctermfg=150 ctermbg=237 cterm=NONE
hi perlspecialstring guifg=#cc5258 guibg=#3a3940 guisp=#3a3940 gui=NONE ctermfg=167 ctermbg=238 cterm=NONE
hi doxygenspecial guifg=#6acc4a guibg=NONE guisp=NONE gui=NONE ctermfg=113 ctermbg=NONE cterm=NONE
hi mbechanged guifg=#cca3cb guibg=#3f2839 guisp=#3f2839 gui=NONE ctermfg=182 ctermbg=237 cterm=NONE
hi mbevisiblechanged guifg=#cca3cb guibg=#8f3871 guisp=#8f3871 gui=NONE ctermfg=182 ctermbg=96 cterm=NONE
hi doxygenparam guifg=#6acc4a guibg=NONE guisp=NONE gui=NONE ctermfg=113 ctermbg=NONE cterm=NONE
hi doxygensmallspecial guifg=#6acc4a guibg=NONE guisp=NONE gui=NONE ctermfg=113 ctermbg=NONE cterm=NONE
hi doxygenprev guifg=#6acc4a guibg=NONE guisp=NONE gui=NONE ctermfg=113 ctermbg=NONE cterm=NONE
hi perlspecialmatch guifg=#cc5258 guibg=#3a3940 guisp=#3a3940 gui=NONE ctermfg=167 ctermbg=238 cterm=NONE
hi cformat guifg=#cc5258 guibg=#3a3940 guisp=#3a3940 gui=NONE ctermfg=167 ctermbg=238 cterm=NONE
hi lcursor guifg=#3a3940 guibg=#50e5ff guisp=#50e5ff gui=NONE ctermfg=238 ctermbg=81 cterm=NONE
hi doxygenspecialmultilinedesc guifg=#a0ad9a guibg=NONE guisp=NONE gui=NONE ctermfg=108 ctermbg=NONE cterm=NONE
hi taglisttagname guifg=#cc43c1 guibg=NONE guisp=NONE gui=NONE ctermfg=170 ctermbg=NONE cterm=NONE
hi doxygenbrief guifg=#76cc21 guibg=NONE guisp=NONE gui=NONE ctermfg=76 ctermbg=NONE cterm=NONE
hi mbevisiblenormal guifg=#cacc9e guibg=#8f3871 guisp=#8f3871 gui=NONE ctermfg=187 ctermbg=96 cterm=NONE
hi user2 guifg=#a150a0 guibg=#5d2b5e guisp=#5d2b5e gui=NONE ctermfg=133 ctermbg=53 cterm=NONE
hi user1 guifg=#9ca9cc guibg=#5d2b5e guisp=#5d2b5e gui=NONE ctermfg=146 ctermbg=53 cterm=NONE
hi doxygenspecialonelinedesc guifg=#a0ad9a guibg=NONE guisp=NONE gui=NONE ctermfg=108 ctermbg=NONE cterm=NONE
hi doxygencomment guifg=#ad02ad guibg=NONE guisp=NONE gui=NONE ctermfg=127 ctermbg=NONE cterm=NONE
hi cspecialcharacter guifg=#cc5258 guibg=#3a3940 guisp=#3a3940 gui=NONE ctermfg=167 ctermbg=238 cterm=NONE
hi htmlitalic guifg=#cc4316 guibg=#1f071f guisp=#1f071f gui=italic ctermfg=166 ctermbg=234 cterm=NONE
hi htmlboldunderlineitalic guifg=#cc4316 guibg=#1f071f guisp=#1f071f gui=bold,italic,underline ctermfg=166 ctermbg=234 cterm=bold,underline
hi htmlbolditalic guifg=#cc4316 guibg=#1f071f guisp=#1f071f gui=bold,italic ctermfg=166 ctermbg=234 cterm=bold
hi htmlunderlineitalic guifg=#cc4316 guibg=#1f071f guisp=#1f071f gui=italic,underline ctermfg=166 ctermbg=234 cterm=underline
hi htmlbold guifg=#cc4316 guibg=#1f071f guisp=#1f071f gui=bold ctermfg=166 ctermbg=234 cterm=bold
hi htmlboldunderline guifg=#cc4316 guibg=#1f071f guisp=#1f071f gui=bold,underline ctermfg=166 ctermbg=234 cterm=bold,underline
hi htmlunderline guifg=#cc4316 guibg=#1f071f guisp=#1f071f gui=underline ctermfg=166 ctermbg=234 cterm=underline
"hi default -- no settings --
hi pythonimport guifg=#919386 guibg=NONE guisp=NONE gui=NONE ctermfg=101 ctermbg=NONE cterm=NONE
hi pythonexception guifg=#ccb7cc guibg=NONE guisp=NONE gui=NONE ctermfg=252 ctermbg=NONE cterm=NONE
hi pythonbuiltinfunction guifg=#919386 guibg=NONE guisp=NONE gui=NONE ctermfg=101 ctermbg=NONE cterm=NONE
hi pythonoperator guifg=#718aa4 guibg=NONE guisp=NONE gui=NONE ctermfg=103 ctermbg=NONE cterm=NONE
hi pythonexclass guifg=#919386 guibg=NONE guisp=NONE gui=NONE ctermfg=101 ctermbg=NONE cterm=NONE
hi pythonbuiltin guifg=#959691 guibg=NONE guisp=NONE gui=NONE ctermfg=246 ctermbg=NONE cterm=NONE
hi phpstringdouble guifg=#6b11cc guibg=NONE guisp=NONE gui=NONE ctermfg=56 ctermbg=NONE cterm=NONE
hi htmltagname guifg=#6b11cc guibg=NONE guisp=NONE gui=NONE ctermfg=56 ctermbg=NONE cterm=NONE
hi javascriptstrings guifg=#6b11cc guibg=NONE guisp=NONE gui=NONE ctermfg=56 ctermbg=NONE cterm=NONE
hi htmlstring guifg=#6b11cc guibg=NONE guisp=NONE gui=NONE ctermfg=56 ctermbg=NONE cterm=NONE
hi phpstringsingle guifg=#6b11cc guibg=NONE guisp=NONE gui=NONE ctermfg=56 ctermbg=NONE cterm=NONE
